...
class pCorpDetail extends pageAssembly
{
	...
	function killList()
	{
		...
		switch ($this->view)
		{
			...
			case 'violent_systems':
				...
				//-------------------------------------------------------------------------------
				// MOST EXPENSIVE TOPLIST MOD by Evoke. Salvoxia
				// BEGIN
				//-------------------------------------------------------------------------------
				case "expensive_kills":
	...
	function menuSetup()
	{
		...
		// BEGIN
		//-------------------------------------------------------------------------------
		$this->addMenuItem("link", "Most exp. kills",
		edkURI::build($args, array('view', 'expensive_kills', true)));
		$this->addMenuItem("link", "Most exp. losses",
		edkURI::build($args, array('view', 'expensive_losses', true)));
		//-------------------------------------------------------------------------------
		// MOST EXPENSIVE TOPLIST MOD by Evoke. Salvoxia
		// END
